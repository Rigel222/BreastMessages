									...
									<tbody class="clndr-body">
										<?php 
											...
											for ($i=0; $i<($maxday+$startday); $i++) {
												$t=(($i - $startday + 1)==$today)?$todayEvent:$past;
												if(($i % 7) == 0 ) echo "<tr>";
												if($i < $startday) echo "<td></td>";
												else echo ("<td onclick='modelAvailability(event);' class='day".$t.$quot.">");echo("<div class='day-contents'>". ($i - $startday + 1) . $divClose."</td>");
												if(($i % 7) == 6 ) echo "</tr>";
											}
											?>
									</tbody>
